...
import img1 from '../../img/temp/sp5.jpeg'; // sp5
import img2 from '../../img/temp/sp4.jpeg'; //sp4
 
const back = require('../../img/back.png');   // back.png
const cart = require('../../img/cartfull.png'); // cartful.png
